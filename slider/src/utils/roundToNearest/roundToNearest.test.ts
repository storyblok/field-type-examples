...
describe('roundToNearest', () => {
  describe('increment = 1', () => {
    ...
    it('should round value when step < 1', () => {
      ...
      expect(roundToNearest(-0.5, 1)).toEqual(0)
      expect(roundToNearest(-0.25, 1)).toEqual(0)
      expect(roundToNearest(0, 1)).toEqual(0)
      expect(roundToNearest(0.25, 1)).toEqual(0)
  ...
  describe('increment > 1', () => {
    ...
    it('should round value when step < increment', () => {
      ...
      expect(roundToNearest(-1, 2)).toEqual(0)
      expect(roundToNearest(0, 2)).toEqual(0)
      expect(roundToNearest(0.5, 2)).toEqual(0)
      expect(roundToNearest(1, 2)).toEqual(2)
      expect(roundToNearest(2, 2)).toEqual(2)
      expect(roundToNearest(3, 2)).toEqual(4)
      expect(roundToNearest(4, 2)).toEqual(4)
